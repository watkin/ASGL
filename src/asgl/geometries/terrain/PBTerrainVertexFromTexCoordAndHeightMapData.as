package asgl.geometries.terrain {
	...
	public class PBTerrainVertexFromTexCoordAndHeightMapData extends PBData {
		public static const A:uint = 0x1;
		public static const B:uint = 0x2;
		public static const G:uint = 0x4;
		public static const R:uint = 0x8;
		
		[Embed(source="PBTerrainVertexFromTexCoordAndHeightMap.pbj", mimeType="application/octet-stream")] private var PBJBytes:Class;
		public function PBTerrainVertexFromTexCoordAndHeightMapData() {
			super(new PBJBytes());
		}
		/**
		 ...
		 */
		public function setData(dest:*, vertices:Vector.<Number>, texCoords:*, heightMap:BitmapData, valueType:uint, minY:Number, maxY:Number, repeat:Boolean):void {
			var numData:uint;
			var f2:Float2;
