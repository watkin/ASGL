package asgl.geometries.primitives {
	...
	public class SimpleCylinder {
		public static function create(radius:Number, height:Number, heightSegs:int=1, capSegs:int=1, sides:int=3, generateTexCoords:Boolean=true):MeshAsset {
			if (heightSegs < 1) heightSegs = 1;
			if (capSegs < 1) capSegs = 1;
			if (sides < 3) sides = 3;
			
			var mo:MeshAsset = new MeshAsset();
			mo.name = 'SimpleCylinder';
			...
			var v:Float3 = new Float3(radius);
