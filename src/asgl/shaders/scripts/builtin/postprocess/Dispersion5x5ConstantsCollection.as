package asgl.shaders.scripts.builtin.postprocess {
	...
	public class Dispersion5x5ConstantsCollection extends ShaderConstantsCollection {
		private var _matrix:ShaderConstants;
		private var _texAtt:ShaderConstants;
		
		public function Dispersion5x5ConstantsCollection() {
		}
		...
		public function set matrix(value:ShaderConstants):void {
			_matrix = value;
			_setConstants(ShaderPropertyType.FILTER_MATRIX_55, value);
		}
